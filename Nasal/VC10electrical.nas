...
var Generator = {
    ...
    get_output_volts : func {
        var out = 0;
        if(me.gen_drive_switch.getBoolValue() and getprop("engines/engine["~me.gen_index~"]/running")){
...
#var battery = Battery.new(switch-prop,volts_output,ideal_volts,amps,amp_hours,charge_percent,charge_amps);
var battery1 = Battery.new("VC10/electric/dc/battery-switch1","/VC10/electric/dc/battery1",24.6,25,34,1.0,7.0);
var battery2 = Battery.new("VC10/electric/dc/battery-switch2","/VC10/electric/dc/battery2",24.6,25,34,1.0,7.0);

###                            num,switch,									gen_output,                rpm_source,           rpm_threshold,volts,amps
var generator1 = Generator.new(0,"VC10/electric/ac/generator/gen-drive[0]","/engines/engine[0]/amp-v","/engines/engine[0]/n1",20.0,			115.0,60.0);
var generator2 = Generator.new(1,"VC10/electric/ac/generator/gen-drive[1]","/engines/engine[1]/amp-v","/engines/engine[1]/n1",20.0,			115.0,60.0);
var generator3 = Generator.new(2,"VC10/electric/ac/generator/gen-drive[2]","/engines/engine[2]/amp-v","/engines/engine[2]/n1",20.0,			115.0,60.0);
var generator4 = Generator.new(3,"VC10/electric/ac/generator/gen-drive[3]","/engines/engine[3]/amp-v","/engines/engine[3]/n1",20.0,			115.0,60.0);
var ELRAT = 	 Generator.new(4,"VC10/electric/ac/generator/gen-drive[4]","/engines/APU/amp-v",	  "/velocities/airspeed-kt",140.0,		115.0,10.0);
var	TRU1 = 		 Generator.new(5,																	  "VC10/electric/no1-genAC-bus",100.0,	28.0,150.0);	
var	TRU2 = 		 Generator.new(6,																	  "VC10/electric/no4-genAC-bus",100.0,	28.0,150.0);	
var	EmergencyTRU=Generator.new(7,"systems/electrical/outputs/essACbus_volts",100.0,28.0,50.0,0);	
#####################################
